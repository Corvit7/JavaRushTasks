...
//    public Class<Item> getProxy(Class<Item> tClass, Class<?>...interfaces )
//    {
//
//        ClassLoader classLoader = this.getClass().getClassLoader();
//        ItemInvocationHandler invocationHandler = new ItemInvocationHandler();
//        return (Class<Item>) Proxy.newProxyInstance(classLoader, interfaces, invocationHandler);
//    }

//    public <T> Object getProxy(Class... classes) {
//        return Proxy.newProxyInstance(this.getClass().getClassLoader(), classes, new ItemInvocationHandler());
//    }

//    public <T extends Item> T getProxy(Class<T> returning, Class<?> ... classes)
//    {
